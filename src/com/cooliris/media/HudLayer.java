...
public final class HudLayer extends Layer {
	...
	HudLayer(Context context) {
		...
		mNormalBottomMenu = new MenuBar.Menu[] {
				shareMenu,
				deleteMenu,
				moreMenu };
		mSingleViewIntentBottomMenu = new MenuBar.Menu[] {
				shareMenu,
				moreMenu };

		mNormalBottomMenuNoShare = new MenuBar.Menu[] {
				deleteMenu,
				moreMenu };
		...
		mSelectionMenuTop.setMenus(new MenuBar.Menu[] {
				...
				new MenuBar.Menu.Builder("").build(),
	...
	public boolean onTouchEvent(MotionEvent event) {
		if (mMode == MODE_SELECT) {
			/*
			 * setMode(MODE_NORMAL); ArrayList<MediaBucket> displayBuckets = mGridLayer.getSelectedBuckets(); // use
			 * this list, and then clear the items return true;
			 */
			return false;
		} else {
			return false;
