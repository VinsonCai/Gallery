...
public final class LoadingLayer extends Layer {
	...
	private static final int[] PRELOAD_RESOURCES_ASYNC_UNSCALED = {
			R.drawable.stack_frame,
			R.drawable.grid_frame,
			R.drawable.stack_frame_focus,
			R.drawable.stack_frame_gold,
			R.drawable.btn_location_filter_unscaled,
			R.drawable.videooverlay,
			R.drawable.grid_check_on,
			R.drawable.grid_check_off,
			R.drawable.icon_camera_small_unscaled,
			R.drawable.icon_picasa_small_unscaled };

	private static final int[] PRELOAD_RESOURCES_ASYNC_SCALED = {/*
																 * Res.drawable.btn_camera_pressed , Res.drawable.
																 * btn_camera_focus , Res.drawable. fullscreen_hud_bg ,
																 * Res.drawable. icon_delete, Res.drawable. icon_edit,
																 * Res.drawable. icon_more, Res.drawable. icon_share,
																 * Res.drawable. selection_bg_upper , Res.drawable.
																 * selection_menu_bg , Res.drawable.
																 * selection_menu_bg_pressed , Res.drawable.
																 * selection_menu_bg_pressed_left , Res.drawable.
																 * selection_menu_bg_pressed_right , Res.drawable.
																 * selection_menu_divider , Res.drawable. timebar_bg,
																 * Res.drawable. timebar_knob , Res.drawable.
																 * timebar_knob_pressed , Res.drawable. timebar_prev ,
																 * Res.drawable. timebar_next , Res.drawable. mode_grid,
																 * Res.drawable. mode_stack, Res.drawable.
																 * icon_camera_small , Res.drawable. icon_location_small
																 * , Res.drawable. icon_picasa_small , Res.drawable.
																 * icon_folder_small , Res.drawable. scroller_new ,
																 * Res.drawable. scroller_pressed_new , Res.drawable.
																 * btn_camera, Res.drawable. btn_play, Res.drawable
																 * .pathbar_bg, Res.drawable. pathbar_cap, Res.drawable.
																 * pathbar_join , Res.drawable. transparent,
																 * Res.drawable. icon_home_small , Res.drawable.
																 * ic_fs_details , Res.drawable. ic_spinner1,
																 * Res.drawable. ic_spinner2, Res.drawable. ic_spinner3,
																 * Res.drawable. ic_spinner4, Res.drawable. ic_spinner5,
																 * Res.drawable. ic_spinner6, Res.drawable. ic_spinner7,
																 * Res.drawable. ic_spinner8
																 */};
